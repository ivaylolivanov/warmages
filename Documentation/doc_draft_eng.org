...
The collision detection happens in the update phase of the game loop. The very detection is simple implementation of the 'Axis aligned bounding box' method.
